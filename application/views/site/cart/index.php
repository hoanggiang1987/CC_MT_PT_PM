      ...
      <form action="<?php echo base_url('cart/update')?>" method="post">
            <table id="cart_ccontents">
               ...
               <tbody>
                    ...
                    <tr>
                       <td colspan="5">
                       Tổng số tiền thanh toán: <b style="color:red"><?php echo number_format($total_amount)?>. VND</b>
                       - <a href="<?php echo base_url('cart/del')?>"><input type="button" value="Xóa toàn bộ" /></a>
                       </td>
                    </tr>
                     <tr>
                       <td colspan="5"><button type="submit">Cập nhât</button></td>	
                    </tr>
               </tbody>
            </table>
           </form>
